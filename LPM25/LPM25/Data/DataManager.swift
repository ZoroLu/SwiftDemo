...
class DataManager
{
    let indexSet : [String] = ["A","B","C","D","E","F","G","H","J","K","L","M","N","P","Q","R","S","T","W","X","Y","Z"]
    ...
    let pm25Data : Dictionary<String , String>= [
    ...
    func getIndexSet () -> [String]
    {
        return indexSet;
    }
    
    func getCitiesSet () -> [[String]]
    {
        return citiesSet;
    }
